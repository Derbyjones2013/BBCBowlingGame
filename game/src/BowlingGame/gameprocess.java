...
public class gameprocess {
	...
	int prevBonus = 0;								// track bonus from previous spare/strikes//
...
/////// FRAME LOOP START //////////
	...
	//////// SPARE RECOG//////////
		if (r1 < 10 && r1 + r2 == 10) {								// if roll 1 is less than 10 & roll 1 + roll 2 = 10 its a spare//
				System.out.println(" SPAREEEE!!! ");				// recognize spare //			
				System.out.println("  ");
	...
	////////SPARE ON LAST FRAME RECOGNITION /////
		if (f == 10 && r1 + r2 == 10 && r1 < 10){					// if on frame 10 and both roll = 10 but first was not a strike give extra shot for the spare //
				System.out.println( "extra roll for the spare in the last frame! " );
				System.out.println(" ");
			tenthFrameThirdRoll = true;	
	}
	...
	////////// ROLL 2 10TH FRAME IS OVER 10 ///// 
		if (f == 10 && tenthFrameRoll2 > 10){										// if on the tenth frame and the second roll is over 10, invalid score; re-roll //
	...
	/////// PROCESS POINTS FOR 10TH FRAME 3RD ROLL /////
		...
		///// Nested if statement : if 3 strikes in a row acknowledge/////
	...
	////// ROLL 3 IN FRAME 10 IS FALSE 
		if (tFlastRollScore > 10){													// if 3rd roll on tenth frame, check that roll is not over 10 ///
...
/////// FRAME LOOP END //////////
		...
		if(totalScore == 0){														// print gutter game if 0 on all frames// 
